...
export class ResultServiceabilityTorsionalMomentComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.post.http_post(inputJson).then(
      (response) => {
        ...
        this.summary.setSummaryTable("serviceabilityTorsionalMoment", this.serviceabilityTorsionalMomentPages);
      })
      .catch((error) => {
        this.err = 'error!!\n' + error;
        this.summary.setSummaryTable("serviceabilityTorsionalMoment");
  ...
  private setPages(OutputData: any): boolean {
    try {
      this.serviceabilityTorsionalMomentPages = this.setServiceabilityPages(OutputData);
      return true;
    } catch (e) {
      this.err = e.toString();
      return false;
